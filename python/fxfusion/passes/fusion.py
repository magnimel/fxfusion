...
class Fusion:
    ...
    @staticmethod
    def fused_conv2d_bnorm2d(*args) -> None:
        raise RuntimeError("Symbolic Op: fused_conv_norm_relu should only execute in the C++ runtime engine.")

    @staticmethod
    def fused_conv2d_bnorm2d_relu(*args) -> None:
        raise RuntimeError("Symbolic Op: fused_conv_norm_relu should only execute in the C++ runtime engine.")

FUSION_REGISTRY: Dict[int, FusionOp] = {
    0: FusionOp(
        id=0,
        name="fused_conv2d_bnorm2d_relu",
        target=Fusion.fused_conv2d_bnorm2d_relu,
    ...
    2: FusionOp(
        id=2,
        name="fused_conv2d_bnorm2d",
        target=Fusion.fused_conv2d_bnorm2d,
