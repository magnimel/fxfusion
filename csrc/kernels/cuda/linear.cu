...
// Output: out {M, N}
//
// Operation: out = x @ w^T + b
// =====================================================================
void linear(TensorRegistry& reg, const TensorIds& input_ids, const TensorIds& output_ids, const Params& params, const Cache* cache_base) {
    ...
    TORCH_CHECK(status == CUBLAS_STATUS_SUCCESS, "linear cublasSgemm failed: ", cublas_get_error_string(status));
